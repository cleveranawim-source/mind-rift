  ...
  root.innerHTML = `
    ...
    <div class="tc-skills">
      ...
      <div class="tc-skill-row">
        <button class="tc-skill" data-slot="E" style="--c:${champ.color}"><b><img src="./assets/skills/dash_E.png" alt="" onerror="this.replaceWith(document.createTextNode('💨'))"></b><small>도약</small></button>
        <button class="tc-skill" data-slot="W" style="--c:${champ.color}"><b><img src="./assets/skills/${champ.id}_W.png" alt="" onerror="this.replaceWith(document.createTextNode('${champ.W.emoji || 'W'}'))"></b><small>${champ.W.name}</small></button>
        <button class="tc-skill" data-slot="Q" style="--c:${champ.color}"><b><img src="./assets/skills/${champ.id}_Q.png" alt="" onerror="this.replaceWith(document.createTextNode('${champ.Q.emoji || 'Q'}'))"></b><small>${champ.Q.name}</small></button>
